let ScriptDate,FileConstructor;_316‍.x([["Oracle",()=>Oracle]]);_316‍.w("./scriptdate.js",[["ScriptDate",["ScriptDate"],function(v){ScriptDate=v}]]);_316‍.w("./fileconstructor.js",[["FileConstructor",["FileConstructor"],function(v){FileConstructor=v}]]);
...
const dbConfig = require('../dbconfig.js')
  ...
  async initializeScript(request) {
    ...
    try {
      ...
      _316‍.g.console.log(err)
    } finally {
      if (connection) {
        try {
          await connection.close()
        } catch (err) {
          _316‍.g.console.error(err)
        }
      }
    }
  }
